...
//@author Christian Sfeir (Hiding the cursor's code was taken from @Isemgardium but it was completed by myself)
...
int main() {
    setcursor(0, 0);
    cout << "Cursor OFF (code to hide cursor was taken from @Isengardium and completed by myself)" << endl;
    field.clear();
